...
export default class HederaTxBodySignRequest extends BaseTideRequest {
    /**
     * @param {string} authFlow 
     */
    constructor(authFlow) {
        super("HederaTx", "1", authFlow, new Uint8Array());
        this.txBody = null;
    }
    ...
    serializeDraft() {
        if (this.draft.length === 0) {   
            const txBodyToSign = Serialization.StringToUint8Array(this.txBody)
