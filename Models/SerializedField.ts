...
export default class SerializedField{
    ...
    // Version 2 is required to describe this data can only be sent to PolicyEnabled Enc/dec requests
    // this is due to the encFieldChk now fully consisting of Gk and no data hash
}